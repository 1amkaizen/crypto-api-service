...
# ================== LOGGING ==================
logger = logging.getLogger("monitor.bsc_usdc")
...
USDC_CONTRACT = Web3.to_checksum_address(os.getenv("BSC_USDC_ADDRESS"))

notifier = JualNotifier()


class BSCUSDCMonitor:
    def __init__(self):
...
# ================== ENTRY POINT ==================
async def run_usdc_monitor(order_id: str, chain: str = "bsc"):
    monitor = BSCUSDCMonitor()
